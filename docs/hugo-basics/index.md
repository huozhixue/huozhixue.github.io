...
![基本配置下的预览](//hugoloveit.com/zh-cn/theme-documentation-basics/basic-configuration-preview.zh-cn.png "基本配置下的预览")
...
![完整配置下的预览](//hugoloveit.com/zh-cn/theme-documentation-basics/complete-configuration-preview.zh-cn.png "完整配置下的预览")
...
![语言切换](//hugoloveit.com/zh-cn/theme-documentation-basics/language-switch.gif "语言切换")
