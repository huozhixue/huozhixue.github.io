# 3146：两个字符串的排列差（1152 分）


> <u>**[力扣第 397 场周赛第 1 题](https://leetcode.cn/problems/permutation-difference-between-two-strings/)**</u>
...
class Solution:
    def findPermutationDifference(self, s: str, t: str) -> int:
        ...
        return sum(abs(d[x]-i) for i,x in enumerate(t))
```
46 ms
