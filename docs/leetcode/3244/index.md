# 3244：新增道路查询后的最短距离 II（2270 分）


> <u>**[力扣第 409 场周赛第 3 题](https://leetcode.cn/problems/shortest-distance-after-road-addition-queries-ii/)**</u>
...
- 由于道路不交叉，那么添加道路 (u,v) 后，在 u,v 之间的节点就无用了，直接删掉
- 用数组模拟链表的删除即可
## 解答
