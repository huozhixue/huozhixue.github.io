...
> <u>**[力扣第 558 题](https://leetcode.cn/problems/logical-or-of-two-binary-grids-represented-as-quad-trees/)**</u>
...
- 典型的递归
- 假如 t1 是叶子节点，若 t1 值为 1 即返回 t1，否则返回 t2
- t2 是叶子节点则同理
- 否则，递归得到四个子节点，判断是否都是叶子节点且值相等即可
...
class Solution:
    def intersect(self, quadTree1: 'Node', quadTree2: 'Node') -> 'Node':
        def dfs(t1, t2):
            ...
            a,b = dfs(t1.topLeft, t2.topLeft), dfs(t1.topRight,t2.topRight)
            c,d = dfs(t1.bottomLeft, t2.bottomLeft), dfs(t1.bottomRight, t2.bottomRight)
            if all(v.isLeaf for v in [a,b,c,d]) and a.val==b.val==c.val==d.val:
                return Node(a.val, 1)
            return  Node(0, 0, a, b, c, d)
