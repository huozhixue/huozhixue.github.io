...
{{< version 0.2.10 >}} 支持[本地资源引用](../hugo-content#contents-organization)的完整用法.
...
`image` shortcode 是 `figure` shortcode 的替代. 
`image` shortcode 可以充分利用 [lazysizes](https://github.com/aFarkas/lazysizes) 
...
```markdown
{{</* image src="https://hugoloveit.com/images/lighthouse.jpg" caption="Lighthouse (`image`)"  */>}}
```
...
多维数据可视化的 [平行坐标](https://echarts.apache.org/zh/option.html#series-parallel), 
还有用于 BI 的 [漏斗图](https://echarts.apache.org/zh/option.html#series-funnel), 
...
以 [vector tiles](https://docs.mapbox.com/help/glossary/vector-tiles/) 和 
[Mapbox styles](https://docs.mapbox.com/mapbox-gl-js/style-spec/) 为来源, 将它们渲染成互动式地图.
...
* **light-style** *[可选]* (**第五个**位置参数)
    ...
    浅色主题的地图样式, 默认值是[前置参数](../hugo-content#front-matter)或者
	[网站配置](../hugo-basics#site-configuration)中设置的值.

* **dark-style** *[可选]* (**第六个**位置参数)

    深色主题的地图样式, 默认值是[前置参数](../hugo-content#front-matter)或者
	[网站配置](../hugo-basics#site-configuration)中设置的值.

* **navigation** *[可选]*

    是否添加 [NavigationControl](https://docs.mapbox.com/mapbox-gl-js/api#navigationcontrol), 默认值是
	[前置参数](../hugo-content#front-matter)或者
	[网站配置](../hugo-basics#site-configuration)中设置的值.

* **geolocate** *[可选]*

    是否添加 [GeolocateControl](https://docs.mapbox.com/mapbox-gl-js/api#geolocatecontrol), 默认值是
	[前置参数](../hugo-content#front-matter)或者
	[网站配置](../hugo-basics#site-configuration)中设置的值.

* **scale** *[可选]*

    是否添加 [ScaleControl](https://docs.mapbox.com/mapbox-gl-js/api#scalecontrol), 默认值是
	[前置参数](../hugo-content#front-matter)或者
	[网站配置](../hugo-basics#site-configuration)中设置的值.

* **fullscreen** *[可选]*

   是否添加 [FullscreenControl](https://docs.mapbox.com/mapbox-gl-js/api#fullscreencontrol), 默认值是
   [前置参数](../hugo-content#front-matter)或者
   [网站配置](../hugo-basics#site-configuration)中设置的值.
...
```markdown
{{</* mapbox 104.065463 30.546892 13  */>}}
或者
{{</* mapbox lng=104.065463 lat=30.546892 zoom=13 */>}}
```
...
`music` shortcode 基于 [APlayer](https://github.com/MoePlayer/APlayer) 和 
[MetingJS](https://github.com/metowolf/MetingJS) 提供了一个内嵌的响应式音乐播放器.
...
```markdown
{{</* music url="https://hugoloveit.com/music/Wavelength.mp3" name=Wavelength artist=oldmanyoung 
cover="http://p1.music.126.net/ehaqkehdaCgDmkTtWZ7V5g==/109951165477782965.jpg" */>}}
```
...
```markdown
{{</* music auto="https://y.qq.com/n/yqq/album/001Di11N41SEdY.html" */>}}
或者
{{</* music "https://y.qq.com/n/yqq/album/001Di11N41SEdY.html" */>}}
```
...
```markdown
{{</* music server="netease" type="song" id="28151052" */>}}
或者
{{</* music netease song 28151052 */>}}
```
...
* **theme** *[可选]*
    ...
    {{< version 0.2.0 changed >}} 音乐播放器的主题色, 默认值是 `#aaaaaa`.
...
```markdown
{{</* bilibili BV15t411E7hf */>}}
或者
{{</* bilibili id=BV15t411E7hf */>}}
```
...
```code
https://www.bilibili.com/video/BV1Zt411f7ga?p=9
```

一个带有 `p` 参数的 `bilibili` 示例:

```markdown
{{</* bilibili BV17W411y74a 55 */>}}
或者
{{</* bilibili id=BV17W411y74a p=55 */>}}
```
